...
- diff: `/tmp/pdfanno_w3_revised/diff_w3_v2.json`
...
|---|---|---|---|---:|---:|---:|---:|---|
| anc_4c9b6805 | 'RNA sequencing libraries were prepared u' | relocated | preserved | 2 | 2 | 85.2% | 51.6% | hardcoded fixture label: preserved |
